...
class BaseQAModel(BaseModel):
    ...
    def format_output(self, question = None, context = None, title = None, answer = None, ** kwargs):
        return self.text_encoder.format(
            self.output_format, question = question, context = context, title = title, answer = answer, ** kwargs
        )
