...
from custom_train_objects.losses.text_loss import TextLoss
from custom_train_objects.losses.ge2e_loss import GE2ELoss
from custom_train_objects.losses.qa_retriever_loss import QARetrieverLoss
...
_losses = {
    ...
    'GE2ELoss'          : GE2ELoss,
    'TextLoss'          : TextLoss,
    'QARetrieverLoss'   : QARetrieverLoss,
    ** _keras_losses
}
